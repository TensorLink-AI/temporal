...
def test_encoder_decoder_forward_pass(encoder_decoder_model):
    ...
    decoder_inputs = torch.randn(batch_size, config.prediction_length, config.feature_size)
    ...
    assert output.logits.shape == (batch_size, config.prediction_length, config.feature_size)
...
def test_forward_pass_error_missing_inputs(encoder_decoder_model, decoder_only_model):
