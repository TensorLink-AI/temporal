...
class TimeSeriesTransformerEncoderLayer(nn.Module):
    """
    Transformer encoder layer that uses:
    - registry-based self-attention
    - modular feedforward block
    - configurable normalization and dropout
    """
    ...
    def __init__(self, config, builder: ModuleBuilder):
        ...
        self.activation_fn = nn.functional.__dict__.get(config.hidden_act, F.gelu)
    ...
    def forward(
        ...
        return (hidden_states, attn_output) if output_attentions else (hidden_states,)
