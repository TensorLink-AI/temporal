...
class TimeSeriesTransformerEncoder(nn.Module):
    """
    Transformer encoder using registry-based block construction.

    Args:
        config: TransformerTimeSeriesConfig
        builder: ModuleBuilder
        block_configs: List[TransformerBlockConfig] for each encoder layer
    """
    ...
    def __init__(self, config, builder: ModuleBuilder, block_configs: list[TransformerBlockConfig]):
        ...
        self.layers = nn.ModuleList([
            block_builder.build_block(block_cfg)
